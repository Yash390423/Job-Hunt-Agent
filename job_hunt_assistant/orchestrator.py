...
try:
    ...
    from utils.tracking import log_application, log_llm_usage, save_cover_letter_file
    ...
    from job_hunt_assistant.utils.logger import logger
...
def run_pipeline(job_data, resume_text, user_bio, match_score=None):
...
if __name__ == "__main__":
    try:
        ...
        logger.info("Starting pipeline from orchestrator entry point.")
